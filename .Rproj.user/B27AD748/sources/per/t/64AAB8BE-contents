...
sl <- read_csv("new_traits_persist.csv")
...
height_append<- read_csv("height_append_persist2.csv")
...
dispersalv2 <- read_csv("dispersal_syndrome_persist_updated.csv")
...
#read back in
formv2 <- read_csv("growth_form_persist_updated.csv")
...
#read back in
historyv2 <- read_csv("life_history_persist_updated.csv")
...
#read back in
photov2 <- read_csv("photosynthesis_persist_updated.csv")
...
firev2 <- read_csv("fire_persist_updated.csv")
